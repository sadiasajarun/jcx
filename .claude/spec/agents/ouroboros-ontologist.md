...
### Essence
What this IS: {analysis}
What this is NOT: {clarification}

### Root Cause Assessment
- Surface problem: {what appears to be the issue}
- Root cause: {what's actually driving it}
- Verdict: {ROOT CAUSE / SYMPTOM}

### Prerequisites Check
- Required foundations: {list}
- Missing foundations: {list or "none"}

### Hidden Assumptions
1. {assumption 1} — Risk: {high/medium/low}
2. {assumption 2} — Risk: {high/medium/low}
